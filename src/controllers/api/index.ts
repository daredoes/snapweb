...
export const streamControlSetPosition = (options: StreamControlSetPositionParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'setPosition', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlSeek = (options: StreamControlSeekParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'seek', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlPrevious = (options: StreamControlPreviousParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'previous', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlNext = (options: StreamControlNextParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'next', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlStop = (options: StreamControlStopParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'stop', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlPlayPause = (options: StreamControlPlayPauseParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'playPause', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlPause = (options: StreamControlPauseParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'pause', params: options.params }
  return makeRequest('Stream.Control', payload)
}

export const streamControlPlay = (options: StreamControlPlayParams): ServerRequest => {
  const payload: StreamControlPayload = { id: options.id, command: 'play', params: options.params }
  return makeRequest('Stream.Control', payload)
}
...
export const serverDeleteClient = (options: ServerDeleteClient): ServerRequest => {
