...
const silenceUrl = new URL('./10-seconds-of-silence.mp3', import.meta.url).toString()
const silence = silenceUrl;
const snapcast512 = new URL('./snapcast-512.png', import.meta.url).toString();
...
let audio = new Audio(silenceUrl);
