...
import { Box, Button, Dialog, DialogActions, DialogProps, DialogTitle, FormControlLabel, FormGroup, Switch} from "@mui/material";
...
const SnapclientSettings = ({fullWidth = true, fullScreen: _, onClose = () => {}, ...props}: SnapclientSettingsProps) => {
  ...
  return (
      <Dialog fullScreen={false} onClose={closeSettings} open={open} fullWidth={fullWidth} {...props}>
