...
export interface PreviousTrackButtonProps extends Omit<IconButtonProps, 'children'|'onClick'> {
  streamId: string
}
...
const PreviousTrackButton: React.FC<PreviousTrackButtonProps> = ({
  ...
  return (<IconButton {...props} title={title} onClick={handleClick} disabled={!stream.properties.canGoPrevious}>
    <SkipPrevious />
  </IconButton>)
}
