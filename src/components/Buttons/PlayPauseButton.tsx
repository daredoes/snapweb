...
export interface PlayPauseButtonProps extends Omit<IconButtonProps, 'children'|'onClick'> {
  streamId: string
}
...
const PlayPauseButton: React.FC<PlayPauseButtonProps> = ({
  ...
  const playbackStatus = useMemo(() => stream.properties.playbackStatus, [stream.properties.playbackStatus])
  ...
  return (<IconButton {...props} title={customTitle} onClick={handleClick} disabled={disabled}>
    <Icon />
  </IconButton>)
}
