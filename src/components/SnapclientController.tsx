...
const SnapclientController = ({}: SnapclientController) => {
  ...
  const { connect, connected, serverDetails, clients, groups, api } = useSnapclient()
  ...
  return (
      <Box display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
        ...
        <Box display={'flex'} flexDirection={'row'} minHeight={'200px'} maxWidth={'100%'} sx={{overflowX: 'scroll'}} flexWrap={'wrap'} justifyContent={'space-between'} alignItems={'center'}>
